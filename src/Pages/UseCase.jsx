...
import realTimeIcon from "../assets/UseCase/icon1.png";
import marketIcon from "../assets/UseCase/icon2.png";
import portfolioIcon from "../assets/UseCase/icon3.png";
import assistIcon from "../assets/UseCase/icon4.png";
        ...
        <div className="crypto-wrapper">
          ...
          <div className="bottom-section">
            ...
            <div className="image-section">
              <img
                key={currentIndex}
                src={useCaseData[currentIndex].image}
                alt="robot"
                className={`animated-img slide-${currentIndex}`}
              />
            </div>
